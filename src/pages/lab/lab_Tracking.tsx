...
export default function Lab_Tracking() {
  ...
  const printToken = async (id: string) => {
    ...
    await printLabTokenSlip({ tokenNo, createdAt: o.createdAt, patient: { fullName: o.patient.fullName, phone: o.patient.phone, gender, age }, tests: rows, subtotal, discount, net, printedBy })
  }
