...
export default function Finance_Header({ onToggleSidebar, onToggleTheme, theme }: Props) {
    ...
    <header className="sticky top-0 z-10 h-16 w-full border-b border-slate-200 bg-white/90 backdrop-blur dark:border-slate-700 dark:bg-slate-900/80">
      <div className="flex h-full items-center gap-3 px-4 sm:px-6">
        ...
        <div className="ml-auto flex items-center gap-3 text-sm">
          ...
          <div className="rounded-md border border-slate-200 px-3 py-1.5 text-slate-700 dark:border-slate-700 dark:text-slate-200">{(user as any)?.username || '-'}</div>
