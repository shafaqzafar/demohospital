...
export default function Hospital_Header({ onToggleSidebar, collapsed, onToggleTheme, theme }: Props) {
  ...
  return (
    <header className="sticky top-0 z-10 h-16 w-full border-b border-slate-200 bg-white/80 backdrop-blur shadow-sm dark:border-slate-700 dark:bg-slate-900/80">
      <div className="flex h-full items-center gap-3 px-4 sm:px-6">
        ...
        <Link to="/hospital" className="flex items-center gap-2">
          ...
          <div className="font-semibold text-slate-900 dark:text-slate-200">HospitalCare</div>
