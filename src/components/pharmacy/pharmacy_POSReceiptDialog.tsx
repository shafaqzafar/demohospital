...
export default function Pharmacy_POSReceiptDialog({ open, onClose, receiptNo, method, lines, discountPct = 0, lineDiscountRs = 0, customer, autoPrint }: Props) {
  if (!open) return null
              ...
              <div className="mt-3 border-t border-dashed pt-2 text-sm print:text-black">
                ...
                <div className="mt-2 grid grid-cols-6 border-t border-dashed pt-2">
                  ...
                  {lineDisc>0 && (<>
                    ...
                    <div className="col-span-2 amount tabular-nums">{lineDisc.toFixed(2)}</div>
                  </>)}
