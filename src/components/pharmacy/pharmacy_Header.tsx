    ...
    <header className="sticky top-0 z-10 h-16 w-full border-b border-slate-200 bg-white/90 backdrop-blur">
      <div className="flex h-full items-center gap-3 px-4 sm:px-6">
        <button
          ...
          className="mr-1 inline-flex h-9 w-9 items-center justify-center rounded-md border border-slate-200 text-slate-700 hover:bg-slate-50"
        ...
        <Link to="/pharmacy" className="flex items-center gap-2">
          ...
          <div className="hidden sm:block">
            <div className="text-xs font-medium text-slate-500">{pharmacyName}</div>
            <div className="text-sm font-bold bg-linear-to-r from-sky-600 to-indigo-600 bg-clip-text text-transparent">HealthSpire</div>
          </div>
          <div className="font-semibold text-slate-900 sm:hidden">{pharmacyName}</div>
          <span className="ml-2 rounded-full bg-emerald-100 px-2 py-0.5 text-xs font-medium text-emerald-700">Online</span>
        </Link>
        ...
        <div className="ml-auto flex items-center gap-2 text-sm">
          ...
          <button
            ...
            className="relative inline-flex h-9 w-9 items-center justify-center rounded-lg text-slate-600 hover:bg-slate-100 transition-all"
            title="Notifications"
          >
          ...
          {showThemeToggle ? (
            <button
              ...
              className="inline-flex h-9 w-9 items-center justify-center rounded-md border border-slate-200 text-slate-700 hover:bg-slate-50 sm:hidden"
              title="Toggle theme"
          ...
          <div className="hidden sm:flex items-center rounded-full border border-slate-200 bg-white/70 shadow-sm backdrop-blur overflow-hidden">
            {showThemeToggle ? (
              <button
                type="button"
                onClick={() => onToggleTheme?.()}
                className="inline-flex items-center gap-2 px-3 py-2 text-slate-700 hover:bg-slate-50 transition"
                title="Toggle theme"
              >
            ...
            {showThemeToggle ? <div className="h-6 w-px bg-slate-200" /> : null}

            <div className="px-3 py-2 text-slate-700 capitalize">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-3 py-2 text-slate-700 hover:bg-rose-50 hover:text-rose-700 transition"
              title="Logout"
            >
